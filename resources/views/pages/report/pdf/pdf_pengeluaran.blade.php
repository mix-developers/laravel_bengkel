    ...
    <main class="mt-0">
        ...
        <table class="table-borderless mb-3">
            <tr>
                ...
                <td><b>Data Pengeluaran (Servis)</b></td>
            </tr>
            <tr>
                <td>Tanggal </td>
                <td style="width: 15px" class="text-center">:</td>
    ...
    <main class="mt-0">
        ...
        <table class="table-borderless mb-3">
            <tr>
                <td>Laporan</td>
                <td style="width: 15px" class="text-center">:</td>
                <td><b>Data Pengeluaran (non-servis)</b></td>
            </tr>
            <tr>
                <td>Tanggal </td>
                <td style="width: 15px" class="text-center">:</td>
            ...
            <table class="table_custom" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong> Rp {{ number_format($dataNoService->sum('total_price')) }}</strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
